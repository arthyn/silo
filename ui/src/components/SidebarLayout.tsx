...
const UploadButton = () => (
  <button
    ...
    onClick={() => useDropZone.setState({ status: "dropping" })}
  >
    <svg
    ...
    <div className="sm:grid gap-6 grid-cols-[minmax(max-content,320px),1fr] h-full">
      <aside>
        <div className="sticky top-8 hidden sm:flex flex-col min-h-[calc(100vh-4rem)] max-w-xl">
          ...
          <Link
            to="/settings"
            className="default-ring flex items-center mb-4 font-semibold text-gray-600 hover:underline"
          >
          ...
          <footer className="mt-auto text-gray-600">
            ...
            <p className="font-mono text-indigo-400">
              <a
                className="default-ring underline"
        ...
        <Accordion.Root type="single" collapsible>
          <Accordion.Item value="mobile-nav">
            <Accordion.Content className="accordion-content pb-6">
              ...
              <Link
                to="/settings"
                className="default-ring flex items-center mb-10 font-semibold text-gray-600"
              >
                <CogIcon className="w-5 h-5 mr-2 text-indigo-300" />
                Settings
              </Link>
